...
//  if(window.scrollY > 0){
// head.style.background = 'linear-gradient(90deg, rgba(81,178,214,1) 20%, rgba(171,119,255,1) 61%, rgba(68,64,245,1) 96%)'
//  }
//   }
...
const fieldsArraydDrop2 = [practice,jobOffer,serviceOrder,advert,otherOffer]
...
const schoolDropArr = [shoolTeach,schoolPractice,schoolJob,schoolOrder,schoolAd,schoolOther]
...
const freelanceDropArr = [text1free,text2free,text3free,text4free]
